...
public class ModItems {
    ...
    public static final Item FILLED_SYRINGE_CONTAMINATED = registerItem("filled_syringe_contaminated", new FilledSyringeContaminatedItem(new Item.Settings().maxCount(1)));
